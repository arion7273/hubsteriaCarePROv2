...
HubsteriaCarePRO is a mobile-first senior living, assisted living, memory care, and group home operating system foundation inspired by the operational power of PointClickCare and redesigned around speed, mobility, tenant isolation, and simpler clinical workflows.

This repository currently implements the first product foundation milestone:
...
- Phase 15 Hubsteria Academy with knowledge base, videos, interactive walkthroughs, role-based learning paths, certifications, expiring certification tracking, and AI help guidance
...
- Phase 20 Production Hardening & Enterprise Readiness with HIPAA review, penetration testing, backups, disaster recovery, HA, monitoring, error tracking, CI gates, release candidate process, and enterprise documentation
