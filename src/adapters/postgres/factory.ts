...
export function createPostgresBackendRepositories(
  ...
  return {
    ...
    medicationOrders: new PostgresMedicationOrderRepository(client),
    medicationAdministrations: new PostgresMedicationAdministrationRepository(client),
    incidents: new PostgresIncidentRepository(client),
    complianceIssues: new PostgresComplianceIssueRepository(client),
    billingCharges: new PostgresBillingChargeRepository(client),
    invoices: new PostgresInvoiceRepository(client),
    paymentTransactions: new PostgresPaymentTransactionRepository(client),
